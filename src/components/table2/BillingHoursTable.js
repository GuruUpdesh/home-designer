...
const BillingHoursTable = (props) => {
	...
	const [billingHoursTableSearchData, setBillingHoursTableSearchData] = useState(
	...
	function searchHandler(value) {
		...
		setBillingHoursTableSearchData(totalSearchResult);
	}
	...
	return (
		<div className="tableContainer">
			<TableHeader
				...
				length={billingHoursTableSearchData.length}
			...
			<div className="tableWrapper">
				<table>
					...
					<tbody>
						{billingHoursTableSearchData.map((data, index) => {
							return (
								<TableRow
									data={[
										{ value: data.employee, type: "text" },
										{ value: data.project, type: "text" },
										{ value: data.description, type: "text"},
										{ value: data.timeIn, type: "text" },
										{ value: data.timeOut, type: "text" },
									]}
									index={index}
...
export default BillingHoursTable;
